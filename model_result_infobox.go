...
// checks if the ResultInfobox type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultInfobox{}

// ResultInfobox struct for ResultInfobox
type ResultInfobox struct {
	...
	Props *ResultInfoboxProps `json:"props,omitempty"`
}

type _ResultInfobox ResultInfobox
...
// SetProps gets a reference to the given ResultInfoboxProps and assigns it to the Props field.
func (o *ResultInfobox) SetProps(v ResultInfoboxProps) {
	o.Props = &v
}

func (o ResultInfobox) MarshalJSON() ([]byte, error) {
...
func (o ResultInfobox) ToMap() (map[string]interface{}, error) {
...
func (o *ResultInfobox) UnmarshalJSON(data []byte) (err error) {
	...
	varResultInfobox := _ResultInfobox{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultInfobox)

	if err != nil {
		return err
	}

	*o = ResultInfobox(varResultInfobox)

	return err
}

type NullableResultInfobox struct {
	value *ResultInfobox
	isSet bool
}

func (v NullableResultInfobox) Get() *ResultInfobox {
	return v.value
}

func (v *NullableResultInfobox) Set(val *ResultInfobox) {
	v.value = val
	v.isSet = true
}

func (v NullableResultInfobox) IsSet() bool {
	return v.isSet
}

func (v *NullableResultInfobox) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultInfobox(val *ResultInfobox) *NullableResultInfobox {
	return &NullableResultInfobox{value: val, isSet: true}
}

func (v NullableResultInfobox) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultInfobox) UnmarshalJSON(src []byte) error {
	v.isSet = true
