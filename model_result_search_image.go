...
// checks if the ResultSearchImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultSearchImage{}

// ResultSearchImage struct for ResultSearchImage
type ResultSearchImage struct {
	Url string `json:"url"`
	Height *int32 `json:"height,omitempty"`
	Width *int32 `json:"width,omitempty"`
}

type _ResultSearchImage ResultSearchImage
...
func (o ResultSearchImage) MarshalJSON() ([]byte, error) {
...
func (o ResultSearchImage) ToMap() (map[string]interface{}, error) {
...
func (o *ResultSearchImage) UnmarshalJSON(data []byte) (err error) {
	...
	varResultSearchImage := _ResultSearchImage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultSearchImage)

	if err != nil {
		return err
	}

	*o = ResultSearchImage(varResultSearchImage)

	return err
}

type NullableResultSearchImage struct {
	value *ResultSearchImage
	isSet bool
}

func (v NullableResultSearchImage) Get() *ResultSearchImage {
	return v.value
}

func (v *NullableResultSearchImage) Set(val *ResultSearchImage) {
	v.value = val
	v.isSet = true
}

func (v NullableResultSearchImage) IsSet() bool {
	return v.isSet
}

func (v *NullableResultSearchImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultSearchImage(val *ResultSearchImage) *NullableResultSearchImage {
	return &NullableResultSearchImage{value: val, isSet: true}
}

func (v NullableResultSearchImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultSearchImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
