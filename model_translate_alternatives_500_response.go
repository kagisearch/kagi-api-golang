...
// checks if the TranslateAlternatives500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateAlternatives500Response{}

// TranslateAlternatives500Response struct for TranslateAlternatives500Response
type TranslateAlternatives500Response struct {
...
func NewTranslateAlternatives500Response() *TranslateAlternatives500Response {
	this := TranslateAlternatives500Response{}
	return &this
}
...
func (o TranslateAlternatives500Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateAlternatives500Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateAlternatives500Response struct {
	value *TranslateAlternatives500Response
	isSet bool
}

func (v NullableTranslateAlternatives500Response) Get() *TranslateAlternatives500Response {
	return v.value
}

func (v *NullableTranslateAlternatives500Response) Set(val *TranslateAlternatives500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateAlternatives500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateAlternatives500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateAlternatives500Response(val *TranslateAlternatives500Response) *NullableTranslateAlternatives500Response {
	return &NullableTranslateAlternatives500Response{value: val, isSet: true}
}

func (v NullableTranslateAlternatives500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateAlternatives500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
