...
// checks if the TranslateTextAlignments400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateTextAlignments400Response{}

// TranslateTextAlignments400Response struct for TranslateTextAlignments400Response
type TranslateTextAlignments400Response struct {
...
func NewTranslateTextAlignments400Response() *TranslateTextAlignments400Response {
	this := TranslateTextAlignments400Response{}
	return &this
}
...
func (o TranslateTextAlignments400Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateTextAlignments400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateTextAlignments400Response struct {
	value *TranslateTextAlignments400Response
	isSet bool
}

func (v NullableTranslateTextAlignments400Response) Get() *TranslateTextAlignments400Response {
	return v.value
}

func (v *NullableTranslateTextAlignments400Response) Set(val *TranslateTextAlignments400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateTextAlignments400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateTextAlignments400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateTextAlignments400Response(val *TranslateTextAlignments400Response) *NullableTranslateTextAlignments400Response {
	return &NullableTranslateTextAlignments400Response{value: val, isSet: true}
}

func (v NullableTranslateTextAlignments400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateTextAlignments400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
