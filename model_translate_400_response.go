...
// checks if the Translate400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Translate400Response{}

// Translate400Response struct for Translate400Response
type Translate400Response struct {
	// Error message
...
func (o Translate400Response) MarshalJSON() ([]byte, error) {
...
func (o Translate400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslate400Response struct {
	value *Translate400Response
	isSet bool
}

func (v NullableTranslate400Response) Get() *Translate400Response {
	return v.value
}

func (v *NullableTranslate400Response) Set(val *Translate400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslate400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslate400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslate400Response(val *Translate400Response) *NullableTranslate400Response {
	return &NullableTranslate400Response{value: val, isSet: true}
}

func (v NullableTranslate400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslate400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
