...
// checks if the TranslateDetect400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateDetect400Response{}

// TranslateDetect400Response struct for TranslateDetect400Response
type TranslateDetect400Response struct {
...
func NewTranslateDetect400Response() *TranslateDetect400Response {
	this := TranslateDetect400Response{}
	return &this
}
...
func (o TranslateDetect400Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateDetect400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateDetect400Response struct {
	value *TranslateDetect400Response
	isSet bool
}

func (v NullableTranslateDetect400Response) Get() *TranslateDetect400Response {
	return v.value
}

func (v *NullableTranslateDetect400Response) Set(val *TranslateDetect400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateDetect400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateDetect400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateDetect400Response(val *TranslateDetect400Response) *NullableTranslateDetect400Response {
	return &NullableTranslateDetect400Response{value: val, isSet: true}
}

func (v NullableTranslateDetect400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateDetect400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
