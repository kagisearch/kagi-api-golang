...
// checks if the ResultVideo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultVideo{}

// ResultVideo struct for ResultVideo
type ResultVideo struct {
	...
	Props *ResultVideoProps `json:"props,omitempty"`
}

type _ResultVideo ResultVideo
...
// SetProps gets a reference to the given ResultVideoProps and assigns it to the Props field.
func (o *ResultVideo) SetProps(v ResultVideoProps) {
	o.Props = &v
}

func (o ResultVideo) MarshalJSON() ([]byte, error) {
...
func (o ResultVideo) ToMap() (map[string]interface{}, error) {
...
func (o *ResultVideo) UnmarshalJSON(data []byte) (err error) {
	...
	varResultVideo := _ResultVideo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultVideo)

	if err != nil {
		return err
	}

	*o = ResultVideo(varResultVideo)

	return err
}

type NullableResultVideo struct {
	value *ResultVideo
	isSet bool
}

func (v NullableResultVideo) Get() *ResultVideo {
	return v.value
}

func (v *NullableResultVideo) Set(val *ResultVideo) {
	v.value = val
	v.isSet = true
}

func (v NullableResultVideo) IsSet() bool {
	return v.isSet
}

func (v *NullableResultVideo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultVideo(val *ResultVideo) *NullableResultVideo {
	return &NullableResultVideo{value: val, isSet: true}
}

func (v NullableResultVideo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultVideo) UnmarshalJSON(src []byte) error {
	v.isSet = true
