...
// checks if the TranslateFile403Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateFile403Response{}

// TranslateFile403Response struct for TranslateFile403Response
type TranslateFile403Response struct {
...
func (o TranslateFile403Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateFile403Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateFile403Response struct {
	value *TranslateFile403Response
	isSet bool
}

func (v NullableTranslateFile403Response) Get() *TranslateFile403Response {
	return v.value
}

func (v *NullableTranslateFile403Response) Set(val *TranslateFile403Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateFile403Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateFile403Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateFile403Response(val *TranslateFile403Response) *NullableTranslateFile403Response {
	return &NullableTranslateFile403Response{value: val, isSet: true}
}

func (v NullableTranslateFile403Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateFile403Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
