...
// checks if the ResultInfoboxPropsInfoboxInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultInfoboxPropsInfoboxInner{}

// ResultInfoboxPropsInfoboxInner struct for ResultInfoboxPropsInfoboxInner
type ResultInfoboxPropsInfoboxInner struct {
	Header string `json:"header"`
	Value string `json:"value"`
	Merged bool `json:"merged"`
}

type _ResultInfoboxPropsInfoboxInner ResultInfoboxPropsInfoboxInner
...
func NewResultInfoboxPropsInfoboxInner(header string, value string, merged bool) *ResultInfoboxPropsInfoboxInner {
	this := ResultInfoboxPropsInfoboxInner{}
	this.Header = header
	this.Value = value
	this.Merged = merged
	return &this
...
func (o ResultInfoboxPropsInfoboxInner) MarshalJSON() ([]byte, error) {
...
func (o ResultInfoboxPropsInfoboxInner) ToMap() (map[string]interface{}, error) {
...
func (o *ResultInfoboxPropsInfoboxInner) UnmarshalJSON(data []byte) (err error) {
	...
	varResultInfoboxPropsInfoboxInner := _ResultInfoboxPropsInfoboxInner{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultInfoboxPropsInfoboxInner)

	if err != nil {
		return err
	}

	*o = ResultInfoboxPropsInfoboxInner(varResultInfoboxPropsInfoboxInner)

	return err
}

type NullableResultInfoboxPropsInfoboxInner struct {
	value *ResultInfoboxPropsInfoboxInner
	isSet bool
}

func (v NullableResultInfoboxPropsInfoboxInner) Get() *ResultInfoboxPropsInfoboxInner {
	return v.value
}

func (v *NullableResultInfoboxPropsInfoboxInner) Set(val *ResultInfoboxPropsInfoboxInner) {
	v.value = val
	v.isSet = true
}

func (v NullableResultInfoboxPropsInfoboxInner) IsSet() bool {
	return v.isSet
}

func (v *NullableResultInfoboxPropsInfoboxInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultInfoboxPropsInfoboxInner(val *ResultInfoboxPropsInfoboxInner) *NullableResultInfoboxPropsInfoboxInner {
	return &NullableResultInfoboxPropsInfoboxInner{value: val, isSet: true}
}

func (v NullableResultInfoboxPropsInfoboxInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultInfoboxPropsInfoboxInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
