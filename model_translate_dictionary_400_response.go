...
// checks if the TranslateDictionary400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateDictionary400Response{}

// TranslateDictionary400Response struct for TranslateDictionary400Response
type TranslateDictionary400Response struct {
	// Error message
...
func NewTranslateDictionary400Response() *TranslateDictionary400Response {
	this := TranslateDictionary400Response{}
	return &this
}
...
func (o TranslateDictionary400Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateDictionary400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateDictionary400Response struct {
	value *TranslateDictionary400Response
	isSet bool
}

func (v NullableTranslateDictionary400Response) Get() *TranslateDictionary400Response {
	return v.value
}

func (v *NullableTranslateDictionary400Response) Set(val *TranslateDictionary400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateDictionary400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateDictionary400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateDictionary400Response(val *TranslateDictionary400Response) *NullableTranslateDictionary400Response {
	return &NullableTranslateDictionary400Response{value: val, isSet: true}
}

func (v NullableTranslateDictionary400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateDictionary400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
