...
type SearchObject struct {
	...
	Thumbnail *ResultSearchImage `json:"thumbnail,omitempty"`
...
// SetThumbnail gets a reference to the given ResultSearchImage and assigns it to the Thumbnail field.
