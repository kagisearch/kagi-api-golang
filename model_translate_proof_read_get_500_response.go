...
// checks if the TranslateProofReadGet500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateProofReadGet500Response{}

// TranslateProofReadGet500Response struct for TranslateProofReadGet500Response
type TranslateProofReadGet500Response struct {
	// Error message
...
func NewTranslateProofReadGet500Response() *TranslateProofReadGet500Response {
	this := TranslateProofReadGet500Response{}
	return &this
}
...
func (o TranslateProofReadGet500Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateProofReadGet500Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateProofReadGet500Response struct {
	value *TranslateProofReadGet500Response
	isSet bool
}

func (v NullableTranslateProofReadGet500Response) Get() *TranslateProofReadGet500Response {
	return v.value
}

func (v *NullableTranslateProofReadGet500Response) Set(val *TranslateProofReadGet500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateProofReadGet500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateProofReadGet500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateProofReadGet500Response(val *TranslateProofReadGet500Response) *NullableTranslateProofReadGet500Response {
	return &NullableTranslateProofReadGet500Response{value: val, isSet: true}
}

func (v NullableTranslateProofReadGet500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateProofReadGet500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
