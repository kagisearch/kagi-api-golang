...
// checks if the TranslateWordInsights500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateWordInsights500Response{}

// TranslateWordInsights500Response struct for TranslateWordInsights500Response
type TranslateWordInsights500Response struct {
...
func NewTranslateWordInsights500Response() *TranslateWordInsights500Response {
	this := TranslateWordInsights500Response{}
	return &this
}
...
func (o TranslateWordInsights500Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateWordInsights500Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateWordInsights500Response struct {
	value *TranslateWordInsights500Response
	isSet bool
}

func (v NullableTranslateWordInsights500Response) Get() *TranslateWordInsights500Response {
	return v.value
}

func (v *NullableTranslateWordInsights500Response) Set(val *TranslateWordInsights500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateWordInsights500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateWordInsights500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateWordInsights500Response(val *TranslateWordInsights500Response) *NullableTranslateWordInsights500Response {
	return &NullableTranslateWordInsights500Response{value: val, isSet: true}
}

func (v NullableTranslateWordInsights500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateWordInsights500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
