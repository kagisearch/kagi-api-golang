...
// checks if the UploadText type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UploadText{}

// UploadText Used to upload text to be summarized
type UploadText struct {
	Text string `json:"text"`
}

type _UploadText UploadText
...
func (o UploadText) MarshalJSON() ([]byte, error) {
...
func (o UploadText) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["text"] = o.Text
	return toSerialize, nil
}

func (o *UploadText) UnmarshalJSON(data []byte) (err error) {
	...
	varUploadText := _UploadText{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUploadText)

	if err != nil {
		return err
	}

	*o = UploadText(varUploadText)

	return err
}

type NullableUploadText struct {
	value *UploadText
	isSet bool
}

func (v NullableUploadText) Get() *UploadText {
	return v.value
}

func (v *NullableUploadText) Set(val *UploadText) {
	v.value = val
	v.isSet = true
}

func (v NullableUploadText) IsSet() bool {
	return v.isSet
}

func (v *NullableUploadText) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUploadText(val *UploadText) *NullableUploadText {
	return &NullableUploadText{value: val, isSet: true}
}

func (v NullableUploadText) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUploadText) UnmarshalJSON(src []byte) error {
	v.isSet = true
