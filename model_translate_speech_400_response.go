...
// checks if the TranslateSpeech400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateSpeech400Response{}

// TranslateSpeech400Response struct for TranslateSpeech400Response
type TranslateSpeech400Response struct {
...
func NewTranslateSpeech400Response() *TranslateSpeech400Response {
	this := TranslateSpeech400Response{}
	return &this
}
...
func (o TranslateSpeech400Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateSpeech400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateSpeech400Response struct {
	value *TranslateSpeech400Response
	isSet bool
}

func (v NullableTranslateSpeech400Response) Get() *TranslateSpeech400Response {
	return v.value
}

func (v *NullableTranslateSpeech400Response) Set(val *TranslateSpeech400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateSpeech400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateSpeech400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateSpeech400Response(val *TranslateSpeech400Response) *NullableTranslateSpeech400Response {
	return &NullableTranslateSpeech400Response{value: val, isSet: true}
}

func (v NullableTranslateSpeech400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateSpeech400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
