...
------------ | ------------- | ------------- | -------------
**Search** | Pointer to [**[]SearchResult**](SearchResult.md) | Contains all search results for html pages or wedbsites. | [optional] 
...
**PodcastCreator** | Pointer to [**[]SearchResult**](SearchResult.md) | Contains all search results for creators of podcasta. | [optional] 
...
**InterestingNews** | Pointer to [**[]SearchResult**](SearchResult.md) | Contains news results from publishers collected and stored in Kagis&#39; news index. | [optional] 
**InterestingFinds** | Pointer to [**[]SearchResult**](SearchResult.md) | Contains small web results from publishers collected and stored in Kagis&#39; small web index. | [optional] 
