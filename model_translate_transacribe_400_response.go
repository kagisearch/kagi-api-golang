...
// checks if the TranslateTransacribe400Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateTransacribe400Response{}

// TranslateTransacribe400Response struct for TranslateTransacribe400Response
type TranslateTransacribe400Response struct {
...
func NewTranslateTransacribe400Response() *TranslateTransacribe400Response {
	this := TranslateTransacribe400Response{}
	return &this
}
...
func (o TranslateTransacribe400Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateTransacribe400Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateTransacribe400Response struct {
	value *TranslateTransacribe400Response
	isSet bool
}

func (v NullableTranslateTransacribe400Response) Get() *TranslateTransacribe400Response {
	return v.value
}

func (v *NullableTranslateTransacribe400Response) Set(val *TranslateTransacribe400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateTransacribe400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateTransacribe400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateTransacribe400Response(val *TranslateTransacribe400Response) *NullableTranslateTransacribe400Response {
	return &NullableTranslateTransacribe400Response{value: val, isSet: true}
}

func (v NullableTranslateTransacribe400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateTransacribe400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
