...
// checks if the TranslateFile415Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateFile415Response{}

// TranslateFile415Response struct for TranslateFile415Response
type TranslateFile415Response struct {
...
func (o TranslateFile415Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateFile415Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateFile415Response struct {
	value *TranslateFile415Response
	isSet bool
}

func (v NullableTranslateFile415Response) Get() *TranslateFile415Response {
	return v.value
}

func (v *NullableTranslateFile415Response) Set(val *TranslateFile415Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateFile415Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateFile415Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateFile415Response(val *TranslateFile415Response) *NullableTranslateFile415Response {
	return &NullableTranslateFile415Response{value: val, isSet: true}
}

func (v NullableTranslateFile415Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateFile415Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
