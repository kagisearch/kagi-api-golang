...
// checks if the TranslateAlternatives401Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateAlternatives401Response{}

// TranslateAlternatives401Response struct for TranslateAlternatives401Response
type TranslateAlternatives401Response struct {
...
func NewTranslateAlternatives401Response() *TranslateAlternatives401Response {
	this := TranslateAlternatives401Response{}
	return &this
}
...
func (o TranslateAlternatives401Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateAlternatives401Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateAlternatives401Response struct {
	value *TranslateAlternatives401Response
	isSet bool
}

func (v NullableTranslateAlternatives401Response) Get() *TranslateAlternatives401Response {
	return v.value
}

func (v *NullableTranslateAlternatives401Response) Set(val *TranslateAlternatives401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateAlternatives401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateAlternatives401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateAlternatives401Response(val *TranslateAlternatives401Response) *NullableTranslateAlternatives401Response {
	return &NullableTranslateAlternatives401Response{value: val, isSet: true}
}

func (v NullableTranslateAlternatives401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateAlternatives401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
