...
// checks if the TranslateTransacribe500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TranslateTransacribe500Response{}

// TranslateTransacribe500Response struct for TranslateTransacribe500Response
type TranslateTransacribe500Response struct {
...
func NewTranslateTransacribe500Response() *TranslateTransacribe500Response {
	this := TranslateTransacribe500Response{}
	return &this
}
...
func (o TranslateTransacribe500Response) MarshalJSON() ([]byte, error) {
...
func (o TranslateTransacribe500Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslateTransacribe500Response struct {
	value *TranslateTransacribe500Response
	isSet bool
}

func (v NullableTranslateTransacribe500Response) Get() *TranslateTransacribe500Response {
	return v.value
}

func (v *NullableTranslateTransacribe500Response) Set(val *TranslateTransacribe500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslateTransacribe500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslateTransacribe500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslateTransacribe500Response(val *TranslateTransacribe500Response) *NullableTranslateTransacribe500Response {
	return &NullableTranslateTransacribe500Response{value: val, isSet: true}
}

func (v NullableTranslateTransacribe500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslateTransacribe500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
