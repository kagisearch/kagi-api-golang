...
// checks if the ResultSearchPropsThumbnailImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResultSearchPropsThumbnailImage{}

// ResultSearchPropsThumbnailImage struct for ResultSearchPropsThumbnailImage
type ResultSearchPropsThumbnailImage struct {
	Url string `json:"url"`
	Height *int32 `json:"height,omitempty"`
	Width *int32 `json:"width,omitempty"`
}

type _ResultSearchPropsThumbnailImage ResultSearchPropsThumbnailImage
...
func NewResultSearchPropsThumbnailImage(url string) *ResultSearchPropsThumbnailImage {
	this := ResultSearchPropsThumbnailImage{}
	this.Url = url
	return &this
}
...
func (o ResultSearchPropsThumbnailImage) MarshalJSON() ([]byte, error) {
...
func (o ResultSearchPropsThumbnailImage) ToMap() (map[string]interface{}, error) {
...
func (o *ResultSearchPropsThumbnailImage) UnmarshalJSON(data []byte) (err error) {
	...
	varResultSearchPropsThumbnailImage := _ResultSearchPropsThumbnailImage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varResultSearchPropsThumbnailImage)

	if err != nil {
		return err
	}

	*o = ResultSearchPropsThumbnailImage(varResultSearchPropsThumbnailImage)

	return err
}

type NullableResultSearchPropsThumbnailImage struct {
	value *ResultSearchPropsThumbnailImage
	isSet bool
}

func (v NullableResultSearchPropsThumbnailImage) Get() *ResultSearchPropsThumbnailImage {
	return v.value
}

func (v *NullableResultSearchPropsThumbnailImage) Set(val *ResultSearchPropsThumbnailImage) {
	v.value = val
	v.isSet = true
}

func (v NullableResultSearchPropsThumbnailImage) IsSet() bool {
	return v.isSet
}

func (v *NullableResultSearchPropsThumbnailImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResultSearchPropsThumbnailImage(val *ResultSearchPropsThumbnailImage) *NullableResultSearchPropsThumbnailImage {
	return &NullableResultSearchPropsThumbnailImage{value: val, isSet: true}
}

func (v NullableResultSearchPropsThumbnailImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResultSearchPropsThumbnailImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
