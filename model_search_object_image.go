...
var _ MappedNullable = &SearchObjectImage{}
...
func (o SearchObjectImage) MarshalJSON() ([]byte, error) {
...
type NullableSearchObjectImage struct {
	value *SearchObjectImage
	isSet bool
}

func (v NullableSearchObjectImage) Get() *SearchObjectImage {
	return v.value
}

func (v *NullableSearchObjectImage) Set(val *SearchObjectImage) {
	v.value = val
	v.isSet = true
}

func (v NullableSearchObjectImage) IsSet() bool {
	return v.isSet
}

func (v *NullableSearchObjectImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSearchObjectImage(val *SearchObjectImage) *NullableSearchObjectImage {
	return &NullableSearchObjectImage{value: val, isSet: true}
}

func (v NullableSearchObjectImage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSearchObjectImage) UnmarshalJSON(src []byte) error {
	v.isSet = true
