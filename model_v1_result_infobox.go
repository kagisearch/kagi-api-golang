...
// checks if the V1ResultInfobox type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V1ResultInfobox{}

// V1ResultInfobox struct for V1ResultInfobox
type V1ResultInfobox struct {
	Url string `json:"url"`
	Title string `json:"title"`
	Snippet string `json:"snippet"`
	Time *string `json:"time,omitempty"`
	Image *V1ResultSearchImage `json:"image,omitempty"`
	Props *V1ResultInfoboxProps `json:"props,omitempty"`
}

type _V1ResultInfobox V1ResultInfobox
...
// SetProps gets a reference to the given V1ResultInfoboxProps and assigns it to the Props field.
func (o *V1ResultInfobox) SetProps(v V1ResultInfoboxProps) {
	o.Props = &v
}

func (o V1ResultInfobox) MarshalJSON() ([]byte, error) {
...
func (o V1ResultInfobox) ToMap() (map[string]interface{}, error) {
...
func (o *V1ResultInfobox) UnmarshalJSON(data []byte) (err error) {
	...
	varV1ResultInfobox := _V1ResultInfobox{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV1ResultInfobox)

	if err != nil {
		return err
	}

	*o = V1ResultInfobox(varV1ResultInfobox)

	return err
}

type NullableV1ResultInfobox struct {
	value *V1ResultInfobox
	isSet bool
}

func (v NullableV1ResultInfobox) Get() *V1ResultInfobox {
	return v.value
}

func (v *NullableV1ResultInfobox) Set(val *V1ResultInfobox) {
	v.value = val
	v.isSet = true
}

func (v NullableV1ResultInfobox) IsSet() bool {
	return v.isSet
}

func (v *NullableV1ResultInfobox) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV1ResultInfobox(val *V1ResultInfobox) *NullableV1ResultInfobox {
	return &NullableV1ResultInfobox{value: val, isSet: true}
}

func (v NullableV1ResultInfobox) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV1ResultInfobox) UnmarshalJSON(src []byte) error {
	v.isSet = true
