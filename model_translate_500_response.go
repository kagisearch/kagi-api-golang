...
// checks if the Translate500Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Translate500Response{}

// Translate500Response struct for Translate500Response
type Translate500Response struct {
	// Error message
...
func (o Translate500Response) MarshalJSON() ([]byte, error) {
...
func (o Translate500Response) ToMap() (map[string]interface{}, error) {
...
type NullableTranslate500Response struct {
	value *Translate500Response
	isSet bool
}

func (v NullableTranslate500Response) Get() *Translate500Response {
	return v.value
}

func (v *NullableTranslate500Response) Set(val *Translate500Response) {
	v.value = val
	v.isSet = true
}

func (v NullableTranslate500Response) IsSet() bool {
	return v.isSet
}

func (v *NullableTranslate500Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTranslate500Response(val *Translate500Response) *NullableTranslate500Response {
	return &NullableTranslate500Response{value: val, isSet: true}
}

func (v NullableTranslate500Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTranslate500Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
